...
function ListChapProcess(b, d, e, g, k) {
    $("#list-chapter .pagination").replaceWith(g);
    $("#list-chapter>.row").html(k);
    $("html, body").animate({
    ...
    window.history.pushState({
        ...
        truyen_ascii: d,
        page: e
    }, "Truy\u1ec7n " + b + " - Trang " + e, "/" + d + "/trang-" + e + "/#list-chapter");
...
function FormError(b, d) {
    d ? $("#" + d + " .single-page-status").removeClass("alert-success hide").addClass("alert-danger").html(b) : ($(".single-page-status").removeClass("alert-success hide").addClass("alert-danger").html(b), $("html, body").animate({
        scrollTop: $(".single-page-status").offset().top
    }, "slow"))
}

function FormSuccess(b, d) {
    d ? $("#" + d + " .single-page-status").removeClass("alert-danger hide").addClass("alert-success").html(b) : ($(".single-page-status").removeClass("alert-danger hide").addClass("alert-success").html(b), $("html, body").animate({
        scrollTop: $(".single-page-status").offset().top
    }, "slow"))
}
...
function load_comment(b, d, e) {
    $("#" + b).html('<div class="fb-comments" data-href="http://truyenfull.vn/' + d + '/" data-width="100%" width="100%" data-numposts="5" data-colorscheme="' + e + '"></div>');
...
function outbrain_backup(b, d) {
    var e = $("#" + b).html();
    if (-1 === e.indexOf("https://paid.outbrain.com") && -1 === e.indexOf("data-video-id") && -1 === e.indexOf("ob-video-duration")) {
        ...
        g.getElementById("M182108ScriptRootC338407").appendChild(k);
        try {
            var h = k.contentWindow.document;
            h.open();
            h.writeln("<html><body></body></html>");
            h.close();
            var l = h.body
        } catch (r) {
            h = g, l = g.getElementById("M182108ScriptRootC338407")
        }
        ...
        h.defer = "defer";
        h.charset = "utf-8";
        h.src = "//jsc.mgid.com/t/r/truyenfull.vn.338407.js?t=" + e.getYear() + e.getMonth() + e.getUTCDate() + e.getUTCHours();
        l.appendChild(h)
    }
}
var has3d = function() {
    ...
    for (var e in d)
        if (d.hasOwnProperty(e) && void 0 !== b.style[e]) {
...
$(document).ready(function() {
    ...
    if (l) {
        "/" != window.location.pathname && function(a, b, f) {
            var n = a.getElementsByTagName(b)[0];
            a.getElementById(f) || (a = a.createElement(b), a.id = f, a.src = "https://connect.facebook.net/vi_VN/all.js#version=v3.1&appId=333184773543272", n.parentNode.insertBefore(a, n))
        }(document, "script", "facebook-jssdk");
        var r = $("#truyen-comment").val()
    }
    k && ($.browser.mobile ? $("#view-comments").click(function() {
        $(this).fadeOut();
    ...
    if (h) {
        var m = $.cookie("bgcolor-cookie"),
            t = $.cookie("font-cookie"),
            u = $.cookie("size-cookie"),
            x = $.cookie("lineheight-cookie"),
            D = $.cookie("fluid-switch-cookie"),
            E = $.cookie("onebreak-switch-cookie"),
            y = $("#chapter-bnum").val(),
            z = $("#chapter-num").val(),
            p = "light";
        "#232323" == m && (p = "dark");
        ...
        1 == D && ($("#fluid-no").attr("checked", !1), $("#fluid-yes").attr("checked", !0));
        1 == E ? ($("#onebreak-no").attr("checked", !1), $("#onebreak-yes").attr("checked", !0)) : original_content = $(".chapter-c").html();
        $("#truyen-background").on("change", function() {
            var a = this.value;
            "hatsan" == a ? ($("body").css({
                "background-color": "#f2f2f2",
                "background-image": "url('https://cdnvn.truyenfull.vn/img/bg_op.png')",
                "background-repeat": "repeat"
            }).removeClass("dark-background"), $(".footer").removeClass("footer-dark"), p = "light") : "sachcu" == a ? ($("body").css({
                "background-color": "#c2b49b",
                "background-image": "url('https://cdnvn.truyenfull.vn/img/bg_book_op.png')",
                "background-repeat": "repeat"
            }).removeClass("dark-background"), $(".footer").removeClass("footer-dark"), p = "light") : "#232323" == a ? ($("body").css({
                "background-color": a,
                "background-image": "url('https://cdnvn.truyenfull.vn/img/bg_dark.gif')"
            }).addClass("dark-background"), $(".footer").addClass("footer-dark"), p = "dark") : ($("body").css({
                "background-color": a,
                "background-image": "none"
            }).removeClass("dark-background"), $(".footer").removeClass("footer-dark"), p = "light");
    ...
    $("#search-input").keyup(function() {
        ...
        clearTimeout(v);
        a = $(this).val();
        0 == a.length ? $(".list-search-res").html("").addClass("hide") : 3 <= a.length && ($(".list-search-res").html('<img src="https://cdnvn.truyenfull.vn/img/loading-search.gif" alt="loading">').removeClass("hide"), v = setTimeout(function() {
            quick_search(a)
        }, 300))
    });
    $("#search-input").bind("paste", function() {
        ...
        setTimeout(function() {
            var b = $(a).val();
            0 == b.length ? $(".list-search-res").html("").addClass("hide") : 3 <= b.length && ($(".list-search-res").html('<img src="https://cdnvn.truyenfull.vn/img/loading-search.gif" alt="loading">').removeClass("hide"), v = setTimeout(function() {
                quick_search(b)
            }, 300))
        }, 0)
    });
    ...
    $(".top-nav").on("click", "div", function() {
        var a = $(this),
            b = a.attr("data-type"),
            f = a.parent().attr("data-limit"),
            c = a.parent().attr("data-cat");
    ...
    $("#list-chapter").on("submit", "#page_jump", function(a) {
        ...
        isNumber(f) && 0 === f % 1 && $.get("/ajax.php", {
            ...
            ListChapProcess(b, k, f, a.page_list, a.chap_list)
        })
    });
    $("#list-chapter").on("click", ".pagination li a", function(a) {
        ...
        if ("javascript:void(0)" != b) {
            ...
            var f = $("h1").text();
            a = $("#total-page").val();
            if (b == "https://truyenfull.vn/" + k + "/#list-chapter") c = 1;
            else {
                var c = b.match(/(\d+)(?!.*\d)/);
                c = c[1]
            }
            $.get("/ajax.php", {
                ...
                ListChapProcess(f, k, c, a.page_list, a.chap_list)
            })
        }
    });
    */
    ...
    $(".pagination-container").on("submit", "#page_jump", function(a) {
        ...
        var b = $("input[name='page']").val(),
            f = $("input[name='filter']").val();
        a ? isNumber(b) && 0 === b % 1 && (window.location.href = "https://truyenfull.vn/" + a + "/" + k + f + "/trang-" + b + "/") : isNumber(b) && 0 === b % 1 && (window.location.href = "https://truyenfull.vn/" + k + "/trang-" + b + "/#list-chapter")
    });
    ...
    $(".rate-holder").raty({
        number: 10,
        path: "https://cdnvn.truyenfull.vn/lib/raty/images",
        ...
        click: function(a) {
            ...
            localStorage.setItem(l, "rated");
            alert("C\u1ea3m \u01a1n b\u1ea1n \u0111\u00e3 \u0111\u00e1nh gi\u00e1 truy\u1ec7n!")
        },
        readOnly: function() {
            if ("rated" == localStorage.getItem(l)) return !0
        }
    });
    randomso(1, 8);
    ...
    $.browser.mobile ? $(".col-truyen-main").addClass("no-hover") : ($("body").is("#body_truyen") && ($(".ads-780-90").html('\x3c!-- Composite Start --\x3e<div id="M182108ScriptRootC335852" style="display:none"><div id="M182108PreloadC335852"></div></div>\x3c!-- Composite End --\x3e'), function() {
        var a = new Date,
            b = document,
            f = b.createElement("iframe");
        f.style.display = "none";
        b.getElementById("M182108ScriptRootC335852").appendChild(f);
        try {
            var c = f.contentWindow.document;
            c.open();
            c.writeln("<html><body></body></html>");
            c.close();
            var d = c.body
        } catch (B) {
            c = b, d = b.getElementById("M182108ScriptRootC335852")
        }
        ...
        c.defer = "defer";
        c.charset = "utf-8";
        c.src = "//jsc.mgid.com/t/r/truyenfull.vn.335852.js?t=" +
            a.getYear() + a.getMonth() + a.getUTCDate() + a.getUTCHours();
        d.appendChild(c)
    }(), $(".ads-300-250-top").html('\x3c!-- Composite Start --\x3e<div id="M182108ScriptRootC335849" style="display:none"><div id="M182108PreloadC335849"></div></div>\x3c!-- Composite End --\x3e'), function() {
        var a = new Date,
            b = document,
            d = b.createElement("iframe");
        d.style.display = "none";
        b.getElementById("M182108ScriptRootC335849").appendChild(d);
        try {
            ...
            c = b, e = b.getElementById("M182108ScriptRootC335849")
        }
        b = c.createElement("div");
        b.id = "MG_ID";
        b.style.display = "none";
        ...
        c.defer = "defer";
        c.charset = "utf-8";
        c.src = "//jsc.mgid.com/t/r/truyenfull.vn.335849.js?t=" + a.getYear() + a.getMonth() + a.getUTCDate() + a.getUTCHours();
        e.appendChild(c)
    }(), $(".ads-300-250").html('\x3c!-- Composite Start --\x3e<div id="M182108ScriptRootC335851" style="display:none"><div id="M182108PreloadC335851"></div></div>\x3c!-- Composite End --\x3e'), function() {
        var a = new Date,
            b = document,
            d = b.createElement("iframe");
        d.style.display = "none";
        b.getElementById("M182108ScriptRootC335851").appendChild(d);
        try {
            var c = d.contentWindow.document;
            c.open();
            c.writeln("<html><body></body></html>");
            ...
            c = b, e = b.getElementById("M182108ScriptRootC335851")
        }
        b = c.createElement("div");
        b.id = "MG_ID";
        b.style.display = "none";
        ...
        c.defer = "defer";
        c.charset = "utf-8";
        c.src = "//jsc.mgid.com/t/r/truyenfull.vn.335851.js?t=" +
            a.getYear() + a.getMonth() + a.getUTCDate() + a.getUTCHours();
        e.appendChild(c)
    }(), setTimeout(function() {
        $(".ads-780-90 > div, .ads-300-250-top > div, .ads-300-250 > div").fadeIn()
    }, 1E3)), $(".ads-300-600, .ads-300-600-desktop").replaceWith('<iframe class="ads-frame ads-margin" sandbox="allow-forms allow-same-origin allow-scripts allow-popups" style="overflow:hidden" src="//truyenfull.vn/ureka/geniee/geniee-300x250.html" width="300" height="250" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe>'), h && (2E3 <= $(".chapter-c").html().length && (m = $(".chapter-c").find("p, br, img, table"), t = parseInt(m.length / 2), u = randomso(0, 4), m.eq(t).after('<div class="hidden-xs text-center ads-middle ads-holder"><iframe frameborder="0" width="480" height="270" src="//www.dailymotion.com/embed/video/' + ["x6kn1vz", "x5xjtfc", "x6p8qns", "x5xjlc0", "x5xjugm"][u] + '?autoplay-mute=1&mute=1" allowfullscreen="" allow="autoplay"></iframe></div>'), (m = $("div.ads-middle")[0].nextSibling) && 3 != m.nodeType && $("div.ads-middle").next("br").remove(), $("div.ads-middle").prev("br").remove()), $(".ads-780-90-chapter-1").replaceWith('<div id="bg_125121827"></div>'), $.getScript("//vn-platform.bidgear.com/async.php?domainid=1251&sizeid=2&zoneid=1827&k=5b030c2ec8fde"), postscribe("#ads-780-90-chapter-2", '<div class="OUTBRAIN" data-src="https://truyenfull.vn/' + h + '/" data-widget-id="GS_1" data-ob-template="Truyenfull.vn"></div> <script type="text/javascript" async="async" src="//widgets.outbrain.com/outbrain.js">\x3c/script>'), setTimeout(function() {
        outbrain_backup("ads-780-90-chapter-2", "chapter")
...
})(window, document, 'script', 'https://cdnvn.truyenfull.vn/js/analytics.js', 'ga');
ga('create', 'UA-34734851-17', 'auto');
ga('send', 'pageview');;
var outbrain_check;

function outbrain_backup_mobile(b) {
    var a = $(b).html();
    if (-1 === a.indexOf("https://paid.outbrain.com") && -1 === a.indexOf("data-video-id") && -1 === a.indexOf("ob-video-duration"))
        if ("#ads-320-100-backup-4" == b) {
            $(b).html('\x3c!-- Composite Start --\x3e<div id="M182108ScriptRootC337648"><div id="M182108PreloadC337648"></div></div>\x3c!-- Composite End --\x3e');
            b = new Date;
            a = document;
            var f = a.createElement("iframe");
            f.style.display = "none";
            a.getElementById("M182108ScriptRootC337648").appendChild(f);
            try {
                ...
                d = a, e = a.getElementById("M182108ScriptRootC337648")
            }
            ...
            d.defer = "defer";
            d.charset = "utf-8";
            d.src = "//jsc.mgid.com/t/r/truyenfull.vn.337648.js?t=" + b.getYear() + b.getMonth() + b.getUTCDate() + b.getUTCHours();
            e.appendChild(d)
        } else backupads(b)
}

function backupads(b) {
    var a = $("#ten-truyen").val();
    a || (a = $("#truyen-ascii").val());
    $(b).html("");
    outbrain_check ? "#ads-320-100-backup-3" == b ? ($(b).html('\x3c!-- Composite Start --\x3e<div id="M182108ScriptRootC335704"><div id="M182108PreloadC335704"></div></div>\x3c!-- Composite End --\x3e'), function() {
        var b = new Date,
            a = document,
            e = a.createElement("iframe");
        e.style.display = "none";
        a.getElementById("M182108ScriptRootC335704").appendChild(e);
        try {
            ...
            c = a, g = a.getElementById("M182108ScriptRootC335704")
        }
        ...
        c.defer = "defer";
        c.charset = "utf-8";
        c.src = "//jsc.mgid.com/t/r/truyenfull.vn.335704.js?t=" + b.getYear() + b.getMonth() + b.getUTCDate() + b.getUTCHours();
        g.appendChild(c)
    }()) : ($(b).html('\x3c!-- Composite Start --\x3e<div id="M182108ScriptRootC335705"><div id="M182108PreloadC335705"></div></div>\x3c!-- Composite End --\x3e'), function() {
        var b = new Date,
            a = document,
            e = a.createElement("iframe");
        e.style.display = "none";
        a.getElementById("M182108ScriptRootC335705").appendChild(e);
        try {
            var c = e.contentWindow.document;
            c.open();
            c.writeln("<html><body></body></html>");
            ...
            c = a, g = a.getElementById("M182108ScriptRootC335705")
        }
        a = c.createElement("div");
        a.id = "MG_ID";
        a.style.display = "none";
        ...
        c.defer = "defer";
        c.charset = "utf-8";
        c.src = "//jsc.mgid.com/t/r/truyenfull.vn.335705.js?t=" +
            b.getYear() + b.getMonth() + b.getUTCDate() + b.getUTCHours();
        g.appendChild(c)
    }()) : (outbrain_check = 1, postscribe(b, '<div class="OUTBRAIN" data-src="https://truyenfull.vn/' + a + '/" data-widget-id="GS_1" data-ob-template="Truyenfull.vn"></div> <script type="text/javascript" async="async" src="//widgets.outbrain.com/outbrain.js">\x3c/script>'), setTimeout(function() {
        outbrain_backup_mobile(b, "chapter")
    }, 5E3))
}

function fanads_backup_check_2(b, a, f) {
    "chapter" == a ? "ads-320-100-backup-3" == b ? $("iframe#fanads_chapter_1").contents().find(".fbAdLoaded").length || $("iframe#fanads_chapter_1").contents().find(".fbANRoot").length || (a = randomso(1, 7), 1 == a || 2 == a ? backupads("#" + b) : ($("#" + b).html('<div class="fb-middle" id="' + b + '-inside"></div>'), postscribe("#" + b + "-inside", '<script src="//media1.admicro.vn/jspartner/b135.js">\x3c/script>'))) : "ads-320-100-backup-4" == b ? $("iframe#fanads_chapter_3").contents().find(".fbAdLoaded").length || $("iframe#fanads_chapter_3").contents().find(".fbANRoot").length || (a = randomso(1, 7), 1 == a || 2 == a ? backupads("#" + b) : $("#" + b).html('<div class="fb-middle"><a href="https://www.yes24.vn/event-2018/giut-nhanh-nhu-chop?cid=truyenfull&utm_source=truyenfull&utm_medium=cpd&utm_campaign=truyenfull_cpd_eventtraffic" target="_blank" rel="nofollow"><img src="https://cdnvn.truyenfull.vn/taitro/yes24-300x250-3.gif" alt="yes24 ads"></a></div>')) : $("iframe#fanads_chapter_2").contents().find(".fbAdLoaded").length || $("iframe#fanads_chapter_2").contents().find(".fbANRoot").length || (a = randomso(1, 7), 1 == a || 2 == a ? backupads("#" + b) : ($("#" + b).html('<div class="fb-middle" id="' + b + '-inside"></div>'), postscribe("#" + b + "-inside", '<script src="//media1.admicro.vn/jspartner/b148.js">\x3c/script>'))) : $("iframe#fanads_story_1").contents().find(".fbAdLoaded").length || $("iframe#fanads_story_1").contents().find(".fbANRoot").length || backupads("#" + b)
}

function fanads_backup_check(b, a, f) {
    "chapter" == a ? "ads-320-100-backup-3" == b ? $("iframe#fanads_chapter_1").contents().find(".fbAdLoaded").length || $("iframe#fanads_chapter_1").contents().find(".fbANRoot").length || ($("#" + b).html('<div class="fb-middle"><div class="fbsp">SPONSORED/QU\u1ea2NG C\u00c1O</div><iframe style="overflow:hidden" id="fanads_chapter_1" src="//truyenfull.vn/ureka/fb/fullwidth-chapter-1.html" width="100%" height="615" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe></div>'), setTimeout(function() {
        fanads_backup_check_2(b, a)
    }, 4E3)) : "ads-320-100-backup-4" == b ? $("iframe#fanads_chapter_3").contents().find(".fbAdLoaded").length || $("iframe#fanads_chapter_3").contents().find(".fbANRoot").length || ($("#" + b).html('<div class="fb-middle"><div class="fbsp">SPONSORED/QU\u1ea2NG C\u00c1O</div><iframe style="overflow:hidden" id="fanads_chapter_3" src="//truyenfull.vn/ureka/fb/fullwidth-chapter-3.html" width="100%" height="615" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe></div>'), setTimeout(function() {
        fanads_backup_check_2(b, a)
    }, 4E3)) : $("iframe#fanads_chapter_2").contents().find(".fbAdLoaded").length || $("iframe#fanads_chapter_2").contents().find(".fbANRoot").length || ($("#" + b).html('<div class="fb-middle"><div class="fbsp">SPONSORED/QU\u1ea2NG C\u00c1O</div><iframe style="overflow:hidden" id="fanads_chapter_2" src="//truyenfull.vn/ureka/fb/fullwidth-chapter-2.html" width="100%" height="615" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe></div>'), setTimeout(function() {
        fanads_backup_check_2(b, a)
    }, 4E3)) : $("iframe#fanads_story_1").contents().find(".fbAdLoaded").length || $("iframe#fanads_story_1").contents().find(".fbANRoot").length || ($("#" + b).html('<div class="fb-middle"><div class="fbsp">SPONSORED/QU\u1ea2NG C\u00c1O</div><iframe style="overflow:hidden" id="fanads_story_1" src="//truyenfull.vn/ureka/fb/fullwidth-story-1.html" width="100%" height="615" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe></div>'), setTimeout(function() {
        fanads_backup_check_2(b, a)
    }, 4E3))
}
$(document).ready(function() {
    if ($.browser.mobile) {
        randomso(1, 8);
        var b = "#232323" == $.cookie("bgcolor-cookie") ? "-dark" : "";
        if ($("#ten-truyen").val()) {
            $("#chapter-num").val();
            var a = $(".chapter-c").html().length,
                f = $(".chapter-c").find("p, br, img, table");
            if (100 >= a) $("#ads-320-100-backup-1-holder").removeClass("hide"), $(".ads-320-100-backup-1").html('<iframe style="overflow:hidden" id="fanads_short_1" src="//truyenfull.vn/ureka/fb/short-chapter-1' + b + '.html" width="100%" height="340" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe>').addClass("ads-fan-fullwidth");
            else {
                var d = parseInt(f.length / 3);
                f.eq(d).after('<div class="text-center w320 ads-top ads-middle-mobile ads-fan-fullwidth ads-holder" id="ads-320-100-backup-4"><div class="fb-middle"><iframe style="overflow:hidden" id="fanads_chapter_3" src="//truyenfull.vn/ureka/fb/native-chapter-3' + b + '.html" width="100%" height="340" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe></div></div>');
                setTimeout(function() {
                    fanads_backup_check("ads-320-100-backup-4", "chapter")
                }, 3E3);
                var e = $("div.ads-top")[0].nextSibling;
                e && 3 != e.nodeType && $("div.ads-top").next("br").remove();
                $("div.ads-top").prev("br").remove();
                1500 <= a && (f.eq(2 * d).after('<div class="text-center w320 ads-middle ads-middle-mobile ads-fan-fullwidth ads-holder" id="ads-320-100-backup-3"><div class="fb-middle"><iframe style="overflow:hidden" id="fanads_chapter_1" src="//truyenfull.vn/ureka/fb/native-chapter-1' + b + '.html" width="100%" height="340" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe></div></div>'), setTimeout(function() {
                    fanads_backup_check("ads-320-100-backup-3", "chapter")
                }, 3E3), (e = $("div.ads-middle")[0].nextSibling) && 3 != e.nodeType && $("div.ads-middle").next("br").remove(), $("div.ads-middle").prev("br").remove())
            }
            $(".ads-320-100-backup-2").html('<div class="fb-middle"><iframe style="overflow:hidden" id="fanads_chapter_2" src="//truyenfull.vn/ureka/fb/native-chapter-2' + b + '.html" width="100%" height="340" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe></div>').addClass("ads-fan-fullwidth");
            setTimeout(function() {
                fanads_backup_check("ads-320-100-backup-2", "chapter")
            }, 3E3)
        } else $(".ads-320-100-backup-2").length && ($(".ads-320-100-backup-2").html('<div class="fb-middle"><iframe style="overflow:hidden" id="fanads_story_1" src="//truyenfull.vn/ureka/fb/native-story-1.html" width="100%" height="340" scrolling="no" marginwidth="0" marginheight="0" frameborder="0"></iframe></div>').addClass("ads-fan-fullwidth"), setTimeout(function() {
            fanads_backup_check("ads-320-100-backup-2", "story")
        }, 3E3))
    }
});